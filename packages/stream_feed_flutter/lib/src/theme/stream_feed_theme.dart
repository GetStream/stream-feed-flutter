...
class StreamFeedThemeData with Diagnosticable {
  ...
  const StreamFeedThemeData({
    ...
    this.childReactionTheme = const ChildReactionThemeData(
      hoverColor: Colors.lightBlue,
      toggleColor: Colors.lightBlue,
    ),
    this.reactionTheme = const ReactionThemeData(
        hoverColor: Colors.lightBlue,
    ...
    this.primaryIconTheme = const IconThemeData(
      color: Color(0xff757575),
    ),
    this.ogCardTheme = const OgCardThemeData(
        titleTextStyle: TextStyle(
      color: Color(0xff007aff),
      fontSize: 14,
      overflow: TextOverflow.ellipsis,
    )),
    this.userBarTheme = const UserBarThemeData(
        usernameTextStyle: TextStyle(
      color: Color(0xff0ba8e0),
      fontWeight: FontWeight.w700,
      fontSize: 14,
    )),
    this.galleryHeaderTheme = const GalleryHeaderThemeData(
