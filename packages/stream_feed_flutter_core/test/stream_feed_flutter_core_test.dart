...
void main() {
  testWidgets(
    ...
    (tester) async {
      ...
      final streamFeedCore = FeedBlocProvider(
        bloc: FeedBloc(
          client: mockClient,
        ),
      ...
      expect(
          FeedBlocProvider.of(childKey.currentState!.context).bloc, isNotNull);
    },
  );
  testWidgets(
    ...
    (tester) async {
      ...
      expect(
          () => DefaultFeedBlocProvider.of(childKey.currentState!.context),
